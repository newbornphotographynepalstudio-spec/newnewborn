 ...
 *
 * MobileNav is rendered as a sibling of <header>, not nested inside it —
 * <header> has backdrop-blur-sm (a backdrop-filter), and a backdrop-
 * filter/filter/transform on an ancestor creates a new containing block
 * for position:fixed descendants. Nesting MobileNav inside <header>
 * collapsed its "fixed inset-0" full-screen overlay down to the header's
 * own ~64px height instead of the viewport (caught via real browser
 * testing, not just a build — see git history, "Phase 3A").
 */
